...
{		
	...
	function index()
	{
		...
		view::set("pager",sf::getModel("articles")->getPager($addWhere ,$addSql ,30,'','',$from_vars));
		view::apply("inc_body","admin/article/index");
	...
	function delete()
	{
		...
		if(sf::getModel("articles")->remove("`id` IN ('".$ids."')")) $this->page_debug(lang::get("Has been deleted!"),getFromUrl());
