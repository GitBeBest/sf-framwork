...
$.extend($.validator, {
	...
	messages: {
		...
		url: "请填写一个有效的链接地址.",
		date: "请填写有效的日期.",
		dateISO: "请填写有效的日期(ISO).",
		dateDE: "Bitte geben Sie ein gültiges Datum ein.",
		number: "请填写有效的数字.",
		numberDE: "Bitte geben Sie eine Nummer ein.",
		digits: "必须填写数字",
		creditcard: "请填写有效的信用卡.",
		equalTo: "两次输入不一致.",
		accept: "Please enter a value with a valid extension.",
		maxlength: $.format("最长 {0} 个字符."),
		minlength: $.format("最少 {0} 个字符."),
		rangelength: $.format("填写内容必须是 {0} 到 {1} 个字之间."),
		range: $.format("内容从{0} 到 {1}."),
		max: $.format("请填写一个小于 {0} 的内容."),
		min: $.format("请填写一个大于 {0} 的内容.")
	},
